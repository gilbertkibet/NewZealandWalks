...
namespace NewZealandWalks.API.Infrastructure.Data
{
    public class NewZealandWalksDbContext : DbContext
    {
        ...
        {
            //SEED DATA FOR DIFFICULTY  first deefine data and parse to hasdata method
            List<Difficulty> difficulties = new List<Difficulty>()
            {
                new Difficulty()
                {
                  Id=Guid.Parse("58a35898-e618-4ddd-8df7-f3305088cc68"),
                  Name="Easy"
                }    ,
                new Difficulty()
                {
                  Id=Guid.Parse("b2ed793a-3b75-4bfe-91f1-e4d91d565141"),
                  Name="Medium"
                }   ,
                 new Difficulty()
                {
                  Id=Guid.Parse("eaf45e79-2034-4206-bc10-c722c1585e79"),
                  Name="Hard"
                }
            };
